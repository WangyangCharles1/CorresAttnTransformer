...
# @PROJECT: Correspondence Attention Transformer: A Context-sensitive Network for Two-view Correspondence Learning
# @AUTHOR: Jiayi Ma, Yang Wang, Aoxiang Fan, Guobao Xiao, and Riqing Chen 
# @CITATION: DOI 10.1109/TMM.2022.3162115, IEEE
# @HIGHLIGHTS:
#    - MLP-based deep architecture and Self-Attention mechanism for Two-view Correspondence Learning
#    - Spatial MultiHead Attention structure to exploit the geometrical context from different aspects
#    - Second-order Covariance Normalized Channel Attention with less GPU memory
#
